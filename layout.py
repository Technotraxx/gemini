...
def render_sidebar():
    with st.sidebar:
        ...
        if show_advanced:
            ...
            civic_integrity_setting = st.selectbox("Civic Integrity", list(safety_options.keys()), index=1)

            safety_settings = {
                HarmCategory.HARM_CATEGORY_HARASSMENT: safety_options[harassment_setting],
                HarmCategory.HARM_CATEGORY_HATE_SPEECH: safety_options[hate_speech_setting],
                HarmCategory.HARM_CATEGORY_SEXUALLY_EXPLICIT: safety_options[sexually_explicit_setting],
                HarmCategory.HARM_CATEGORY_DANGEROUS_CONTENT: safety_options[dangerous_content_setting],
                HarmCategory.HARM_CATEGORY_CIVIC_INTEGRITY: safety_options[civic_integrity_setting]
            }
